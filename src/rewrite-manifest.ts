...
/**
 * Поколение профилей инспектора rewrite. Ключ и канон хеша те же, что у auth,
 * captcha, json, action и vlai -- docs/inspector-config-distribution.md. Файл
 * у профиля один: YAML. Профиль едет ЦЕЛИКОМ, с выражениями: исполняет их
 * Go-процесс, до nginx они не доезжают.
 *
