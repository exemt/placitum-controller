...
/**
 * Поколение профилей инспектора vlai. Ключ и канон хеша те же, что у auth,
 * captcha, json и action -- docs/inspector-config-distribution.md. Файл у
 * профиля один: YAML; на диск инспектор его не кладёт -- поколение живёт в
 * памяти процесса, а до первой рассылки он работает на встроенном умолчании.
 *
