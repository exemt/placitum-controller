/**
 * Хранение настроек агента: одна строка на пространство.
 *
 * Строки может не быть вовсе -- это нормальное состояние контура, у которого
 * архив настроен на ноде файлом. Тогда `get` возвращает пустой документ, а не
 * 404: страница должна открыться и показать «ничего не задано», а не ошибку.
 */
