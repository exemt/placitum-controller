 ...
 *
 * Здесь же снимок поставки: чем default приходит из `schema/02-seed.sql`.
 ...
 * нормализация читает так же -- ключ выброшен. Описание -- слово в слово как в
 * schema/02-seed.sql.
 */
 ...
 * `src/compile/rule-set-seed.ts`, откуда его берёт и SQL поставки: файлы приходят
