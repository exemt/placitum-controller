...
export function ruleFilesRouter(
  ...
  /*
   * Файл в составе профиля не удаляется: состав -- политика, а не уборка, и
   * профиль, оставшийся пустым, роняет рендер манифеста. Сначала файл убирают
   * из профилей, потом снимают. FK restrict страхует от гонки.
   */
