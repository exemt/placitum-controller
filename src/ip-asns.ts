...
export class IpAsnRepo {
  ...
  /** Есть ли в пространстве хоть один набор ASN: каталог залит или пуст. */
  ...
  /**
   * ASN каждого адреса из пачки: вхождение в префиксы каталога.
   * Индекс и требования к входу -- как у `IpCountryRepo.lookup`.
   */
  async lookup(
    httpSpaceId: string,
    addresses: string[],
