 ...
 *
 * Снимок берётся не из живой базы стенда (она уходит вперёд руками, см.
 * docs/controller/README.md), а из пустого тома, прокатанного архивом миграций.
 ...
 * («Тестовая выгрузка ru/en/jp») по фикстуре inspectors/ip/data/geo, и на
