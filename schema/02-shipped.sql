...
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000002', (select id from public.http_spaces where name = 'default'), 'engine-allow', 'Движок выключен', 'SecRuleEngine Off
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000003', (select id from public.http_spaces where name = 'default'), 'engine-deny', 'Движок блокирует сам', 'SecRuleEngine On
SecAuditEngine Off
SecAuditLog /dev/null
SecDebugLogLevel 0
SecResponseBodyAccess Off
...
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-00000000000b', (select id from public.http_spaces where name = 'default'), 'extra-deny', 'Безусловный отказ', 'SecAction "id:1000000,phase:1,nolog,pass,t:none,setvar:tx.modsec_profile=deny"
...
INSERT INTO public.rule_sets (id, http_space_id, name, description, created_at, updated_at, policy) VALUES ('b0000000-0000-4000-8000-000000000004', (select id from public.http_spaces where name = 'default'), 'allow', 'Движок выключен', '2026-09-12 15:27:33.526865+00', '2026-09-12 15:27:33.526865+00', '{}') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_sets (id, http_space_id, name, description, created_at, updated_at, policy) VALUES ('b0000000-0000-4000-8000-000000000005', (select id from public.http_spaces where name = 'default'), 'deny', 'Отказ на любой запрос', '2026-09-12 15:27:33.526865+00', '2026-09-12 15:27:33.526865+00', '{}') ON CONFLICT DO NOTHING;
...
INSERT INTO public.rule_set_files (id, rule_set_id, rule_file_id, "position") VALUES ('649496ac-0d9a-44bf-9089-57fc5afa953f', 'b0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000002', 0) ON CONFLICT DO NOTHING;
...
INSERT INTO public.rule_set_files (id, rule_set_id, rule_file_id, "position") VALUES ('86ba63c4-5e05-4b31-902b-1c0c1103d57d', 'b0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-00000000000b', 1) ON CONFLICT DO NOTHING;
...
INSERT INTO public.rule_set_files (id, rule_set_id, rule_file_id, "position") VALUES ('d348001f-2a56-4956-89dc-f65b29f9883c', 'b0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000003', 0) ON CONFLICT DO NOTHING;
