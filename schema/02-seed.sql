...
-- node traffic ports and default profiles. Applied after 01-schema.sql.

INSERT INTO public.http_spaces (id, name, nginx, waf_http, waf, raw, raw_nginx, created_at, updated_at, nginx_main) VALUES ('00000000-0000-4000-8000-000000000001', 'default', '{"errorLog": "/var/log/nginx/error.log info", "includes": ["/etc/nginx/mime.types", "/etc/nginx/waf-node.conf"], "sendfile": true, "accessLog": "/var/log/nginx/access.log", "serverTokens": false, "defaultType": "application/octet-stream", "keepaliveTimeoutS": 65}', '{"shmZone": {"name": "waf", "size": "8m"}, "agentSocket": "/var/run/waf/verdict.sock", "maxInflight": 4096}', '{"inspectors": {}}', false, '', '2026-09-12 15:27:32.86284+00', '2026-09-12 15:27:34.903887+00', '{"events": {"workerConnections": 1024}, "errorLog": "/var/log/nginx/error.log info", "loadModules": ["modules/ngx_http_waf_module.so"], "workerProcesses": 2}') ON CONFLICT DO NOTHING;

INSERT INTO public.content_types (id, name, mime, description) VALUES ('c1000000-0000-4000-8000-000000000001', 'text', 'text/plain', 'Plain text') ON CONFLICT DO NOTHING;
...
INSERT INTO public.content_types (id, name, mime, description) VALUES ('c1000000-0000-4000-8000-000000000005', 'binary', 'application/octet-stream', 'Binary file') ON CONFLICT DO NOTHING;
INSERT INTO public.content_types (id, name, mime, description) VALUES ('c1000000-0000-4000-8000-000000000006', 'other', 'application/octet-stream', 'Other') ON CONFLICT DO NOTHING;

INSERT INTO public.action_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('2760e0c4-d28e-428b-b570-cc2eaa3cde13', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{}', '2026-09-12 15:27:34.587148+00', '2026-09-12 15:27:34.587148+00') ON CONFLICT DO NOTHING;

INSERT INTO public.auth_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('93a2ae70-8746-4b92-8676-aa3a6bca1038', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{}', '2026-09-12 15:27:34.696357+00', '2026-09-12 15:27:34.991053+00') ON CONFLICT DO NOTHING;
...
INSERT INTO public.cookie_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('d85a2a9f-dcca-4a5b-868e-95b6631f7795', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{"rules": [], "cookies": [], "conditions": [], "description": ""}', '2026-09-12 15:27:35.489891+00', '2026-09-12 15:27:35.489891+00') ON CONFLICT DO NOTHING;

INSERT INTO public.counter_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('191d1c97-7f56-43b4-8d29-742836ee7c98', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{}', '2026-09-12 15:27:34.65105+00', '2026-09-12 15:27:34.65105+00') ON CONFLICT DO NOTHING;
...
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('27d4c4bc-619b-442e-8f2f-354507b4734d', (select id from public.http_spaces where name = 'default'), 'malformed', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Request not parsed: wrong format (400)', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('2c521647-5b25-49e5-ad60-0ae595cbab64', (select id from public.http_spaces where name = 'default'), 'default_allowlist', 'ip', 1000000, '2026-09-12 15:27:34.74933+00', '2026-09-12 15:27:34.74933+00', 'list', NULL, false, NULL, false, 0, 'Standard list of allowed addresses, empty as shipped', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('4f3584f9-4e1c-47b4-88e7-f2ca477f9fdb', (select id from public.http_spaces where name = 'default'), 'error', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'The protection contour itself failed (502/503)', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('4fd43b34-d6ae-45df-9bb3-8ec0bdf38c44', (select id from public.http_spaces where name = 'default'), 'auth_required', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Second factor needed: the gate found no session (401)', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('7f5be547-094c-4b26-8ead-332fdac259f0', (select id from public.http_spaces where name = 'default'), 'login_form', 'string', 1000000, '2026-09-12 15:27:34.237074+00', '2026-09-12 15:27:34.237074+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Standard gate sign-in form', NULL, false, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('8f6e6e54-2341-4412-870c-bbbe0ec5ce87', (select id from public.http_spaces where name = 'default'), 'suspicious', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Denied on the sum of signals: the score threshold fired', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('95da0716-6811-487e-bacd-58678b8ece75', (select id from public.http_spaces where name = 'default'), 'captcha_page', 'string', 1000000, '2026-09-12 15:27:34.322251+00', '2026-09-12 15:27:34.322251+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Standard captcha page', NULL, false, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('9b12fbd9-8026-467e-805f-dc044a708477', (select id from public.http_spaces where name = 'default'), 'blocked', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Denied by policy: the contour stopped the request', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('a98bd327-a6a9-439e-9cea-5347aa552be9', (select id from public.http_spaces where name = 'default'), 'auth_forbidden', 'string', 1000000, '2026-09-12 15:27:34.935275+00', '2026-09-12 15:27:34.935275+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Signed in without access: the session is in the wrong group (403)', NULL, true, false) ON CONFLICT DO NOTHING;
...
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('c653ae7e-2305-4fa3-8f3d-78cb4e3c451a', (select id from public.http_spaces where name = 'default'), 'too_many', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Request rate exceeded (429)', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('f4d6e96c-f194-406e-b27b-5037e48a07ba', (select id from public.http_spaces where name = 'default'), 'default_blocklist', 'ip', 1000000, '2026-09-12 15:27:34.74933+00', '2026-09-12 15:27:34.74933+00', 'list', NULL, false, NULL, false, 0, 'Standard list of blocked addresses, empty as shipped', NULL, true, false) ON CONFLICT DO NOTHING;
INSERT INTO public.datasets (id, http_space_id, name, type, max_entries, created_at, updated_at, kind, content_type_id, active, live_max, in_nginx, "position", description, ttl, builtin, hash) VALUES ('ff9aa17e-6a68-43fb-a36a-6da99f455e90', (select id from public.http_spaces where name = 'default'), 'captcha_required', 'string', 1000000, '2026-09-12 15:27:34.731454+00', '2026-09-12 15:27:34.731454+00', 'content', 'c1000000-0000-4000-8000-000000000002', false, NULL, false, 0, 'Human check needed: no clearance (403)', NULL, true, false) ON CONFLICT DO NOTHING;
...
INSERT INTO public.deny_responses (id, http_space_id, name, type, spec, "position") VALUES ('d1a0c7e4-3b62-4f58-8c19-6ae240f7b35c', (select id from public.http_spaces where name = 'default'), 'auth_required', 'http', '{"status": 401}', 54) ON CONFLICT DO NOTHING;
INSERT INTO public.deny_responses (id, http_space_id, name, type, spec, "position") VALUES ('d2b1d8f5-4c73-4a69-9d2a-7bf351a8c46d', (select id from public.http_spaces where name = 'default'), 'error', 'http', '{"status": 503}', 70) ON CONFLICT DO NOTHING;
...
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level, installed) VALUES ('0d249ed3-1921-4e9f-80c6-ee7c84334072', (select id from public.http_spaces where name = 'default'), 'vlai', 'waf.req.vlai', 30, '# inspector.conf -- the local queue of the process
queue_max     8;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:33.935897+00', '2026-09-12 15:27:34.665214+00', '{request}', 'Severity classifier: an ML model rates the description in the body and answers with a score.', '', 'info', false) ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('34b8eed9-7107-43bc-8859-a6d13dd4f03c', (select id from public.http_spaces where name = 'default'), 'rewrite', 'waf.req.rewrite', 0, '# inspector.conf -- the local queue of the process
queue_max     16;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:35.081174+00', '2026-09-12 15:27:35.081174+00', '{response,frame}', 'Response changes: body replacement through the exchange, header operations', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('3583778c-6bd1-4904-84f7-095218cac4ce', (select id from public.http_spaces where name = 'default'), 'action', 'waf.req.action', 0, '# inspector.conf -- the local queue of the process
queue_max     16;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:34.583707+00', '2026-09-12 15:27:34.665214+00', '{request}', 'Sender of the action channel: looks at the route and prompts its neighbours -- threshold, note, skip. Checks nothing itself.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('3ed92a9e-0339-4111-b553-fce1e026fa1c', (select id from public.http_spaces where name = 'default'), 'auth', 'waf.req.auth', 0, '# inspector.conf -- the local queue of the process
queue_max     32;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:34.146064+00', '2026-09-12 15:27:35.185001+00', '{request,response}', 'Second factor: a gate in front of the route -- form and TOTP, passage by the session of the profile.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('5f19f68c-64cd-4a43-ab65-26bafdf8d490', (select id from public.http_spaces where name = 'default'), 'modsec', 'waf.req.modsec', 10, '# inspector.conf -- the local queue of the process
queue_max     16;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:33.935897+00', '2026-09-12 15:27:34.665214+00', '{request,response,frame}', 'SecLang rule engine (Coraza): CRS and your own sets, request and response in one transaction.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('71393095-178b-42e5-a7c1-2e323329456a', (select id from public.http_spaces where name = 'default'), 'captcha', 'waf.req.captcha', 0, '# inspector.conf -- the local queue of the process
queue_max     32;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:34.314046+00', '2026-09-12 15:27:34.665214+00', '{request}', 'Captcha: a challenge for a suspicious client; whoever solves it passes by session.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('a4df5a50-bc3b-401f-bad9-f752d6909ca4', (select id from public.http_spaces where name = 'default'), 'cookie', 'waf.req.cookie', 0, '# inspector.conf -- the local queue of the process
queue_max     256;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:35.485557+00', '2026-09-12 15:27:35.485557+00', '{request,response}', 'Cookie: sets and clears Set-Cookie, writes its value into live sets and tells its neighbours. Checks nothing.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('bdcd5209-ecbf-45c9-92dd-1f9e29a10dda', (select id from public.http_spaces where name = 'default'), 'counter', 'waf.req.counter', 0, '# inspector.conf -- the local queue of the process
queue_max     16;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:34.644318+00', '2026-09-12 15:27:34.665214+00', '{request,response,frame}', 'Behavioural count of what was taken: judges the result, not the intent -- how much the client carried off within the window.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('d0534de3-e068-4d97-a5a5-b752ebbec749', (select id from public.http_spaces where name = 'default'), 'ip', 'waf.req.ip', 20, '# inspector.conf -- the local queue of the process
queue_max     16;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:33.935897+00', '2026-09-12 15:27:34.665214+00', '{request}', 'IP filter: countries, ASNs, sets and lists. Answers allow or deny, does not read the body.', '', 'info') ON CONFLICT DO NOTHING;
INSERT INTO public.inspectors (id, http_space_id, name, subject, "position", conf, created_at, updated_at, phases, description, docs_url, log_level) VALUES ('d86788fe-b683-4dfa-91cb-bfc0c5b46c26', (select id from public.http_spaces where name = 'default'), 'json', 'waf.req.json', 0, '# inspector.conf -- the local queue of the process
queue_max     16;
queue_full    drop;
queue_expand  off;
', '2026-09-12 15:27:34.42567+00', '2026-09-12 15:27:34.665214+00', '{request,response,frame}', 'API contract: checks the call against OpenAPI or JSON Schema, reads the whole phase body from the exchange.', '', 'info') ON CONFLICT DO NOTHING;

INSERT INTO public.ip_profiles (id, http_space_id, name, description, created_at, updated_at, default_action, default_code, outcomes) VALUES ('e1000000-0000-4000-8000-000000000001', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile: no rules, allow otherwise', '2026-09-12 15:27:33.697676+00', '2026-09-12 15:27:33.697676+00', 'allow', '', '[]') ON CONFLICT DO NOTHING;

INSERT INTO public.json_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('a379f2d1-d73b-4f54-ba42-945c81ddba89', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{}', '2026-09-12 15:27:34.432558+00', '2026-09-12 15:27:34.432558+00') ON CONFLICT DO NOTHING;
...
INSERT INTO public.ports (id, http_space_id, name, address, port, ssl, http2, proxy_protocol) VALUES ('b7c1f3a2-5d48-4e10-9a6b-2f0c8e5d4713', (select id from public.http_spaces where name = 'default'), 'https-8443', '0.0.0.0', 8443, true, false, false) ON CONFLICT DO NOTHING;

INSERT INTO public.rewrite_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('3f27aec0-496e-4aea-9d34-40df23ae9b98', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{}', '2026-09-12 15:27:35.086708+00', '2026-09-12 15:27:35.086708+00') ON CONFLICT DO NOTHING;

INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000001', (select id from public.http_spaces where name = 'default'), 'engine', 'Engine', 'Include @coraza.conf-recommended
...
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000004', (select id from public.http_spaces where name = 'default'), 'setup-pl1', 'CRS setup, paranoia 1', 'Include @crs-setup.conf.example
...
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000005', (select id from public.http_spaces where name = 'default'), 'setup-pl2', 'CRS setup, paranoia 2', 'Include @crs-setup.conf.example
SecAction "id:900000,phase:1,nolog,pass,t:none,setvar:tx.blocking_paranoia_level=2"
SecAction "id:900110,phase:1,nolog,pass,t:none,setvar:tx.inbound_anomaly_score_threshold=5"
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000006', (select id from public.http_spaces where name = 'default'), 'crs-init', 'CRS 901 + scanners + LFI', 'Include @owasp_crs/REQUEST-901-INITIALIZATION.conf
Include @owasp_crs/REQUEST-913-SCANNER-DETECTION.conf
Include @owasp_crs/REQUEST-930-APPLICATION-ATTACK-LFI.conf
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000007', (select id from public.http_spaces where name = 'default'), 'crs-init-api', 'CRS 901 for API', 'Include @owasp_crs/REQUEST-901-INITIALIZATION.conf
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000008', (select id from public.http_spaces where name = 'default'), 'extra-default', 'Policy default', 'SecRuleRemoveByTag "attack-dos"
...
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000009', (select id from public.http_spaces where name = 'default'), 'extra-strict', 'Policy strict on top of CRS', 'SecRuleRemoveByTag "attack-dos"
...
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-00000000000a', (select id from public.http_spaces where name = 'default'), 'extra-api', 'Policy api on top of CRS', 'SecRuleRemoveByTag "attack-dos"
...
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000016', (select id from public.http_spaces where name = 'default'), 'ssrf.data', 'SSRF dictionary for @pmFromFile', '# Sources:
...
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000017', (select id from public.http_spaces where name = 'default'), 'ssrf-no-scheme.data', 'SSRF without a scheme', '# SSRF patterns without schemes
#
...
lvh.me/
', '2026-09-12 15:27:33.518274+00', '2026-09-12 15:27:33.518274+00') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_files (id, http_space_id, name, description, text_raw, created_at, updated_at) VALUES ('a0000000-0000-4000-8000-000000000018', (select id from public.http_spaces where name = 'default'), 'java-classes.data', 'Java RCE classes', '# Java Classes for use with Java RCEs
#
...
INSERT INTO public.rule_sets (id, http_space_id, name, description, created_at, updated_at, policy) VALUES ('b0000000-0000-4000-8000-000000000001', (select id from public.http_spaces where name = 'default'), 'default', 'Base CRS: XSS, SQLi, LFI, scanners', '2026-09-12 15:27:33.526865+00', '2026-09-12 15:27:33.526865+00', '{}') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_sets (id, http_space_id, name, description, created_at, updated_at, policy) VALUES ('b0000000-0000-4000-8000-000000000002', (select id from public.http_spaces where name = 'default'), 'strict', 'CRS paranoia 2 plus extra scanners/LFI/RCE', '2026-09-12 15:27:33.526865+00', '2026-09-12 15:27:33.526865+00', '{}') ON CONFLICT DO NOTHING;
INSERT INTO public.rule_sets (id, http_space_id, name, description, created_at, updated_at, policy) VALUES ('b0000000-0000-4000-8000-000000000003', (select id from public.http_spaces where name = 'default'), 'api', 'CRS XSS/SQLi with API rules on top', '2026-09-12 15:27:33.526865+00', '2026-09-12 15:27:33.526865+00', '{}') ON CONFLICT DO NOTHING;

INSERT INTO public.vlai_profiles (id, http_space_id, name, description, doc, created_at, updated_at) VALUES ('dc432476-e2c1-409e-b439-106df2293b99', (select id from public.http_spaces where name = 'default'), 'default', 'Default profile', '{}', '2026-09-12 15:27:34.85268+00', '2026-09-12 15:27:34.85268+00') ON CONFLICT DO NOTHING;

INSERT INTO public.captcha_profiles (id, http_space_id, server_id, name, description, doc, created_at, updated_at) VALUES ('92bfad12-eaeb-425e-9605-f9afa11c378e', (select id from public.http_spaces where name = 'default'), NULL, 'default', 'Default profile', '{}', '2026-09-12 15:27:34.322251+00', '2026-09-12 15:27:34.322251+00') ON CONFLICT DO NOTHING;
