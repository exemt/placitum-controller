...
export const en: DeepString<typeof ru> = {
  ...
  cookieProfiles: {
    ...
    tags: "Tags",
    tagsHint: "Enter or a comma adds a tag",
    label: "Label",
    labelHint: "The readable part of the value: google in google~1a2b…",
    labelModes: { any: "any", in: "one of", not_in: "none of" },
    labelShort: "label: {tags}",
    labelNotShort: "label not: {tags}",
    listed: "List",
    listedHint: "Whether the cookie value is in a dynamic list",
    listedModes: { none: "do not check", in: "value in the list", not_in: "value not in the list" },
