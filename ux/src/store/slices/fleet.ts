...
/** Точка темпа канала. Ключ ряда — `<id участника>:<канал>`. */
...
/**
 * Ряды темпа по каналам. Инспекторы и сервисы копятся не по экземплярам, а по
 * имени: их карточка показывает участника целиком, и график должен пережить
 * замену процесса, у которого сменился id.
 */
