...
/*
 * Страница профилей инспектора vlai. Каркас тот же, что у действий
 * (action-profiles.ts); из справочников нужен один -- реестр инспекторов
 * контура: по нему форма предлагает адресатов просьб.
 */
