...
/**
 * Копия набора под новым именем.
 *
 * Состав лежит в детали -- список отдаёт мету со счётчиком, -- поэтому копия
 * сперва читает образец. Списки на проводе идут идентификаторами: в детали они
 * приезжают объектами (имя, вид, живость) ради таблицы карточки.
 */
