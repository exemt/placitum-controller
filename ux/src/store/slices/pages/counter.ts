...
/*
 * Страница счётчика. Каркас тот же, что у контракта (json.ts), плюс общая
 * секция: объявления счётчиков и источники ключей субъектов -- одна на
 * инспектор, профили ссылаются на счётчики по имени.
 */
