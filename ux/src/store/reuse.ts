...
/**
 * Сокет шлёт полный кадр на любой seq. Карточки сравнивают ссылку, поэтому
 * объекты без реальных изменений надо оставлять теми же.
 * `age_ms` в сравнении нет: снимок считает его на каждый кадр, UX рисует
 * возраст из `seen_at`.
 */
