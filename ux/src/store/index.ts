...
export const store = configureStore({
  ...
  /*
   * Проверки RTK на сериализуемость и неизменяемость обходят ВСЁ состояние на
   * каждом действии. Конфиг пространства большой, и в dev это давало 40-300 мс
   * на dispatch (предупреждения в консоли) -- открытие виджета пути собирало
   * секунды блокировки. В production они и так выключены; здесь выключены
   * явно, чтобы dev не врал про скорость панели.
   */
