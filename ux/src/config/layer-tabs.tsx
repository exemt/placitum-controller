/*
  ...
  Правила слоя: ряд разделов, ряд групп и карточка стоят с равным шагом 8px;
  одна вкладка -- одна карточка с шапкой и одной таблицей настроек от рамки до
  рамки; длинный ряд вкладок переносится, а не прокручивается; выбранная
  вкладка запоминается.
*/
