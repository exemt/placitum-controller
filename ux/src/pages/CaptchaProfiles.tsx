 ...
 * строку. Это блок внутри блока, и половина полей в нём была пуста -- у своей
 * картинки нет ни ключей, ни версии, ни поведения при отказе. Ключи и версию
 * задают один раз и глазами не читают: в строке от них остаётся фраза о том,
 * что задано.
 */
