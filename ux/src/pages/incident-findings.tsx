...
/**
 * Находки участника. Форма на проводе одна, а читать её удобнее своим
 * компонентом на тип инспектора: CRS раскладывает семейство правила
 * и цитату, остальные пока рисуют общую строку.
 *
 * Имя каноническое: ip / modsec / vlai. Старые алиасы волн (crs, model, ai)
 * сюда же.
 */
