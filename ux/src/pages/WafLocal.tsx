 ...
 * же колонки. Унаследованное -- та же таблица, запертая: вторым видом того же
 * списка -- строками директив -- оператор читал одно и то же дважды, а на
 * вопрос «что здесь побежит» строки отвечали хуже таблицы.
 */
