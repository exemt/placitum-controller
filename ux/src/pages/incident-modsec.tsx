...
/**
 * Находки CRS. Счёт и время живут в шапке участника; здесь только
 * сработавшие правила. Служебные (инициализация, оценка порога) уходят
 * вниз и рисуются тише: они объясняют транзакцию, а не атаку.
 */
...
/*
 * Улика движка часто приезжает в канонической форме ModSecurity:
 * `Matched Data: <что> found within <где>: <цитата>`. Разбор только
 * для показа; сырую строку оставляем, если форма другая.
 */
const MATCHED =
