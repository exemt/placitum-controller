/*
 * Кольцо последних ошибок участника — секция `errors` пульса.
 *
 * Это не журнал: пять записей, дедуплицированных производителем, — ответ на
 * «почему карточка пожелтела» без похода в docker logs. Текст моноширинный,
 * как он и выглядел бы в логе; возраст и повторы — серым по краям.
 */
